...
public class PaymentActivity1 extends Activity implements PaymentResultWithDataListener, ExternalWalletListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bid = sh.getString("order_id","");

        alertDialogBuilder = new AlertDialog.Builder(PaymentActivity1.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    Toast.makeText(PaymentActivity1.this, "payment is online", Toast.LENGTH_SHORT).show();
